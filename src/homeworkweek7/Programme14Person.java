 ...
 *Method named getFullName without any parameters, it needs to return the full name of
 * the person.  *In case both firstName and lastName fields are empty, Strings return an empty String.  *In case firstName is an empty String, return firstName.
 *In case lastName is an empty String, return lastName.
 ...
 public class Programme14Person {
    ...
    //instance method without parameter with return
    ...
    {
        this.firstName = firstName;    //used this keyword
    }

    //instance method with parameter
    public void setLastName (String lastName)
    {
        this.lastName = lastName;   //used this keyword
    }
    ...
    // without any parameter with return
